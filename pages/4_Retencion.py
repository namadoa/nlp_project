...
from graph.topics.retencion.graph import app as retencion_app
...
st.set_page_config(
    page_title="Consultas sobre Retención en la Fuente",
    page_icon="🧾",
    layout="wide"
)
...
La base de conocimiento incluye conceptos de la Dian sobre retención desde 2017 hasta 2024. Contiene 894 conceptos de la Dian sobre retención.
...
try:
    ...
    index_name = "retencion"  # Índice específico para retención
    ...
    if not pinecone_api_key:
        ...
        # Si no existe el índice específico de retención, usar el índice general
        if index_name not in existing_indexes:
            index_name = os.environ.get("PINECONE_INDEX_NAME", "ejhr")
            st.info(f"Usando el índice general {index_name} para consultas de Retención.")
        ...
        if query:
            ...
            with st.chat_message("assistant"):
                ...
                update_flow(f"🔄 Iniciando procesamiento de la consulta sobre Retención en la Fuente...")
                time.sleep(0.5)
                ...
                # Consultar documentos de Retención con reranking
                try:
                    # Consultar documentos específicos de Retención con reranking
                    ...
                    if not documents:
                        ...
                        response = "Lo siento, no encontré información relevante sobre tu consulta en la base de conocimiento de Retención en la Fuente. Por favor, intenta reformular tu pregunta o consulta otra base de conocimiento."
                        final_flow = '\n'.join(flow_steps)
                        ...
                        update_flow("✍️ Generando respuesta especializada en Retención...")
                        time.sleep(0.5)
                        ...
                        update_flow("✨ Respuesta sobre Retención generada con éxito!")
                    ...
                    update_flow(f"❌ Error al consultar documentos de Retención o generar respuesta: {str(e)}")
