"""
Grafo específico para consultas sobre Timbre.

Este grafo implementa un flujo de procesamiento optimizado para consultas
sobre el Impuesto de Timbre, utilizando reranking para mejorar 
...
from graph.topics.timbre.nodes import (
    retrieve_documents,
    generate_response,
    verify_response
)
...
def set_debug(debug_mode):
    import graph.topics.timbre.nodes as nodes
    nodes.DEBUG = debug_mode

# Para pruebas locales
if __name__ == "__main__":
    print("Probando grafo de Timbre")
    result = app.invoke({"question": "¿Qué documentos están gravados con el impuesto de timbre en Colombia?"})
