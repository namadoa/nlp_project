"""
Grafo específico para consultas sobre IVA.

Este grafo implementa un flujo de procesamiento optimizado para consultas
sobre el Impuesto al Valor Agregado (IVA), utilizando reranking para mejorar 
...
from graph.topics.iva.nodes import (
    retrieve_documents,
    generate_response,
    verify_response
)
...
def set_debug(debug_mode):
    import graph.topics.iva.nodes as nodes
    nodes.DEBUG = debug_mode

# Para pruebas locales
if __name__ == "__main__":
    print("Probando grafo de IVA")
    result = app.invoke({"question": "¿Cuáles son los bienes exentos de IVA en Colombia?"})
